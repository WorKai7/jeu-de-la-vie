...
{
    if (this->generation+1 > this->history.size()) {
        ...
        if (this->generation > this->history.size()) {
            this->history.push_back(this->grid);
        }
        this->grid = newGrid;
        this->generation++;
    } else {
        this->grid = this->history[this->generation];
        this->generation++;
    }
}

void Grille::previousGeneration() {
    if (this->generation > 1) {
        this->generation--;
        this->grid = this->history[this->generation-1];
    }
}
