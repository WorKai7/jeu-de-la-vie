...
Right::Right() {
    ...
    this->previousButton = new QPushButton("Gen précédente");
    ...
    hLayout2->addWidget(width);
    hLayout2->addWidget(height);
    ...
    connect(previousButton, SIGNAL(clicked(bool)), this, SLOT(sendPreviousSignal()));
...
void Right::sendPreviousSignal() {
    emit Right::previousSignal();
}
...
QPushButton* Right::getPreviousButton() const {
