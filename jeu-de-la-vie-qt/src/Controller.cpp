...
Controller::Controller() {
    ...
    connect(vue->getRight(), SIGNAL(previousSignal()), this, SLOT(previousSlot()));
...
void Controller::previousSlot() {
    this->modele->getGrid()->previousGeneration();
    this->updateVue();
}
...
void Controller::startSimulationSlot() {
    ...
    this->vue->getRight()->getPreviousButton()->setDisabled(true);
...
void Controller::stopSimulationSlot() {
    ...
    this->vue->getRight()->getPreviousButton()->setDisabled(false);
